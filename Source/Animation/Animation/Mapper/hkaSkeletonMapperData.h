...
extern HK_EXPORT_ANIMATION const class hkClass hkaSkeletonMapperDataChainMappingClass;
extern HK_EXPORT_ANIMATION const class hkClass hkaSkeletonMapperDataSimpleMappingClass;

#include <Animation/Animation/Rig/hkaSkeleton.h>

extern HK_EXPORT_ANIMATION const hkClass hkaSkeletonMapperDataClass;
...
class HK_EXPORT_ANIMATION hkaSkeletonMapperData 
{
	//+version(2)
	public:
		...
		struct HK_EXPORT_ANIMATION SimpleMapping
		{
		...
		struct HK_EXPORT_ANIMATION ChainMapping
		{
		...
		struct HK_EXPORT_ANIMATION PartitionMappingRange
		{
