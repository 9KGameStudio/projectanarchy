...
HK_FORCE_INLINE hkaiNavVolumePathfindingTask::hkaiNavVolumePathfindingTask( TaskType tt, const hkaiStreamingCollection& collection)
...
HK_FORCE_INLINE void hkaiNavVolumePathfindingTask::set( const hkaiVolumePathfindingUtil::FindPathInput& input)
{
	m_searchParameters = input.m_searchParameters;
}

HK_FORCE_INLINE hkBool32 hkaiNavVolumePathfindingTask::isEquivalent( const hkaiVolumePathfindingUtil::FindPathInput& input) const
{
