...
#ifndef HK_LOCAL_STEERING_JOB_QUEUE_UTILS
#define HK_LOCAL_STEERING_JOB_QUEUE_UTILS

#include <Common/Base/Thread/JobQueue/hkJobQueue.h>

/// Interface implementation for Havok's job queue system
class hkaiLocalSteeringJobQueueUtils
{
public:
...
#endif // HK_LOCAL_STEERING_JOB_QUEUE_UTILS
