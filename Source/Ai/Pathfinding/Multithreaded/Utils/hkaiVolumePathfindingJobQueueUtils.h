...
#ifndef HK_VOLUME_PATHFINDING_JOB_QUEUE_UTILS
#define HK_VOLUME_PATHFINDING_JOB_QUEUE_UTILS

#include <Common/Base/Thread/JobQueue/hkJobQueue.h>

/// Interface implementation for Havok's job queue system
class hkaiVolumePathfindingJobQueueUtils
{
public:
...
#endif // HK_VOLUME_PATHFINDING_JOB_QUEUE_UTILS
