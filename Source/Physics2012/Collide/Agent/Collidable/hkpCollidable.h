...
class hkpCollidable : public hkpCdBody
{
	...
	public:
		...
		HK_FORCE_INLINE void setCollisionFilterInfo( hkUint32 info );
			...
			/// Sets the m_forceCollideOntoPpu flag to make sure that only SPU-supported shapes are solved on the SPU
		void setShapeSizeForSpu();	
#endif
...
#	undef hkpCdBody
#	undef hkpCollidable
#	include <Physics2012/Collide/Agent/Collidable/hkpCollidableSpu.h>
#endif
