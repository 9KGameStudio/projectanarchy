...
#if defined(HK_COMPILER_ARMCC) || defined(HK_COMPILER_GHS) // to prevent auto and specialized being both defined.
HK_SINGLETON_SPECIALIZATION_DECL(hkpUserShapeDisplayBuilder);
#endif
