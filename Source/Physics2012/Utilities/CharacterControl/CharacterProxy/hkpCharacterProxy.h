...
template<typename T> class hkLocalArray;
	...
	#include <Physics2012/Utilities/CharacterControl/CharacterProxy/Multithreaded/Spu/hkpSpuCharacterProxyCollisionCache.h>
	#include <Physics2012/Collide/Query/Collector/PointCollector/hkpFixedBufferCdPointCollector.h>
	class hkpRigidBody;
	class hkpPhantom;
	class hkpSpuWorldLinearCastCollector;
	#define HK_COLLECTOR_TYPE	hkpFixedBufferCdPointCollector
	#define HK_MANIFOLD_ARRAY_TYPE			hkArraySpu<hkpRootCdPoint>
	#define HK_VIRTUAL_ON_PPU
#else	
