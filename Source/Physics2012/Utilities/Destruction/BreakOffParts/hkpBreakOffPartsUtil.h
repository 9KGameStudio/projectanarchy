	...
	public:
		...
		class LimitContactImpulseUtilDefault : public LimitContactImpulseUtil
		{
			...
			public:
					...
					/// Called to return the breaking impulse of the given shape key
				static void HK_CALL getMaxImpulseForContactPointSpu(hkpShapeKey key, hkpEntity* entity, hkUFloat8& strengthOut);
#endif
		};
