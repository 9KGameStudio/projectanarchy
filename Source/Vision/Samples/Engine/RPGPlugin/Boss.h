 ...
 *
 */
#ifndef RPG_PLUGIN_BOSS_H__
#define RPG_PLUGIN_BOSS_H__

#include <Vision/Samples/Engine/RPGPlugin/AiCharacter.h>

/// Character class for the Boss
class RPG_Boss : public RPG_AiCharacter
{
public:
  ...
  VisParticleEffectFile_cl* GetRangedAttackEffectResource();
