 ...
 *
 */
#ifndef RPG_PLUGIN_PLAYER_CHARACTER_H__
#define RPG_PLUGIN_PLAYER_CHARACTER_H__

#include <Vision/Samples/Engine/RPGPlugin/Character.h>

/// Character class for the Player
class RPG_PlayerCharacter : public RPG_Character
{
public:
...
protected:
  ...
  float m_feignDeathDuration;

private:
  V_DECLARE_SERIAL_DLLEXP(RPG_PlayerCharacter, RPG_PLUGIN_IMPEXP);
  V_DECLARE_VARTABLE(RPG_PlayerCharacter, RPG_PLUGIN_IMPEXP);
};
