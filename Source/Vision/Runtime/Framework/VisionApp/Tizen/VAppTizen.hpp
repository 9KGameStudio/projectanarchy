...
{
public:
  static Tizen::App::UiApp* CreateInstance();
  ...
  /// \brief
  ///   Custom handler for the termination of the Tizen UI form.
  void OnFormTerminating();
...
private:
  ...
  static VSmartPtr<VAppTizen> s_spInstance;
};
