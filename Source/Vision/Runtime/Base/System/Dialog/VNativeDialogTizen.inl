...
class VNativeDialogTizen : public IVNativeDialog, public IActionEventListener
{
public:
  class PopupEventListener : public IPropagatedKeyEventListener
  {
  public:
    PopupEventListener(VNativeDialogTizen* pInstance) : m_pInstance(pInstance)
    {
    }
    ...
    virtual bool OnKeyReleased(Tizen::Ui::Control& source, const Tizen::Ui::KeyEventInfo& keyEventInfo)
    {
      ...
      {
        m_pInstance->m_eState = VNativeDialogTizen::CANCELLED;
      }
    ...
    VNativeDialogTizen* m_pInstance;
  };
