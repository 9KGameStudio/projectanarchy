...
class VNativeDialogIos : public IVNativeDialog
{
public:
  VNativeDialogIos()
  {
...
{
  return new VNativeDialogIos();
}

extern "C" void VNativeMobileDialogIos_SetResult(void* pWrapper, int iResult)
{
  reinterpret_cast<VNativeDialogIos*>(pWrapper)->m_eState = static_cast<VNativeDialogIos::State>(iResult);
}
