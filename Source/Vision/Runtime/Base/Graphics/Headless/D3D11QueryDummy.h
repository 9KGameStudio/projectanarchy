...
class D3D11QueryDummy : public ID3D11Query, public UnknownDummy
{
public:
  HKV_NR_IMPLEMENT_IUNKNOWN;
  HKV_NR_IMPLEMENT_ID3D11DEVICECHILD;

  virtual UINT STDMETHODCALLTYPE GetDataSize( void) HKV_NR_UNIMPLEMENTED

    virtual void STDMETHODCALLTYPE GetDesc( 
    /* [annotation] */ 
    __out  D3D11_QUERY_DESC *pDesc) HKV_NR_UNIMPLEMENTED_VOID
};
