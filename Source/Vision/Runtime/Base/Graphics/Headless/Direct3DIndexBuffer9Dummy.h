...
class Direct3DIndexBuffer9Dummy : public IDirect3DIndexBuffer9, public UnknownDummy
{
public:
  Direct3DIndexBuffer9Dummy(int iByteSize) : m_iByteSize(iByteSize), m_pLockedData(NULL), m_iLockCount(0)
  {
  }

  ~Direct3DIndexBuffer9Dummy();
  ...
  STDMETHOD(GetDesc)(THIS_ D3DINDEXBUFFER_DESC *pDesc) HKV_NR_UNIMPLEMENTED;
