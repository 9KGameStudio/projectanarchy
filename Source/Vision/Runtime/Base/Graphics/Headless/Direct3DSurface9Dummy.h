...
#include <Vision/Runtime/Base/Graphics/Headless/Direct3DResource9Dummy.h>
#include <Vision/Runtime/Base/Graphics/Headless/UnknownDummy.h>

class Direct3DSurface9Dummy : public IDirect3DSurface9, public UnknownDummy
{
public:
  Direct3DSurface9Dummy(D3DSURFACE_DESC* pDesc) : m_desc(*pDesc)
  {
  }
  ...
  STDMETHOD(GetDevice)(THIS_ IDirect3DDevice9** ppDevice) HKV_NR_UNIMPLEMENTED
    ...
    STDMETHOD_(D3DRESOURCETYPE, GetType)(THIS) HKV_OVERRIDE { VASSERT_ALWAYS_MSG(false, "Unimplemented null renderer function called"); return D3DRESOURCETYPE();}
