...
class D3D11UnorderedAccessViewDummy : public ID3D11UnorderedAccessView, public UnknownDummy
{
public:
  ...
  HKV_NR_IMPLEMENT_ID3D11VIEW;
    ...
    /* [annotation] */ 
    __out  D3D11_UNORDERED_ACCESS_VIEW_DESC *pDesc) HKV_NR_UNIMPLEMENTED_VOID
};
