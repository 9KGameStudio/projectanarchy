...
// 2014.1
#if (VISION_RESOURCE_VERSION_MAJOR > 2014) || ((VISION_RESOURCE_VERSION_MAJOR == 2014) && (VISION_RESOURCE_VERSION_MINOR >= 1))
  #define HKV_DEPRECATED_2014_1 HKV_DEPRECATED
#else
  #define HKV_DEPRECATED_2014_1
#endif

// 2014.2
#if (VISION_RESOURCE_VERSION_MAJOR > 2014) || ((VISION_RESOURCE_VERSION_MAJOR == 2014) && (VISION_RESOURCE_VERSION_MINOR >= 2))
  #define HKV_DEPRECATED_2014_2 HKV_DEPRECATED
#else
  #define HKV_DEPRECATED_2014_2
#endif

// 2014.3
#if (VISION_RESOURCE_VERSION_MAJOR > 2014) || ((VISION_RESOURCE_VERSION_MAJOR == 2014) && (VISION_RESOURCE_VERSION_MINOR >= 3))
  #define HKV_DEPRECATED_2014_3 HKV_DEPRECATED
#else
  #define HKV_DEPRECATED_2014_3
#endif

// 2015.1
#if (VISION_RESOURCE_VERSION_MAJOR > 2015) || ((VISION_RESOURCE_VERSION_MAJOR == 2015) && (VISION_RESOURCE_VERSION_MINOR >= 1))
  #define HKV_DEPRECATED_2015_1 HKV_DEPRECATED
#else
  #define HKV_DEPRECATED_2015_1
#endif

// 2015.2
#if (VISION_RESOURCE_VERSION_MAJOR > 2015) || ((VISION_RESOURCE_VERSION_MAJOR == 2015) && (VISION_RESOURCE_VERSION_MINOR >= 2))
  #define HKV_DEPRECATED_2015_2 HKV_DEPRECATED
#else
  #define HKV_DEPRECATED_2015_2
#endif

// 2015.3
#if (VISION_RESOURCE_VERSION_MAJOR > 2015) || ((VISION_RESOURCE_VERSION_MAJOR == 2015) && (VISION_RESOURCE_VERSION_MINOR >= 3))
  #define HKV_DEPRECATED_2015_3 HKV_DEPRECATED
#else
  #define HKV_DEPRECATED_2015_3
#endif
