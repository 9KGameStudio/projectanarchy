...
/// \file vPlatformStubWiiU.hpp

#ifndef VPLATFORMSTUBWIIU_HPP
#define VPLATFORMSTUBWIIU_HPP

// this define should only be set when the WIN32 version
// supports the GLES2 (i.e. to save shaders from vForge, ...)
#define WIN32_SUPPORTS_WIIU

#include <Vision/Runtime/Base/PlatformStub/vPlatformStubBase.hpp>

#ifndef _VISION_DOC

class VBASE_IMPEXP_CLASS vPlatformStubWiiU : public vPlatformStubBase
{
public:
  vPlatformStubWiiU();
  virtual ~vPlatformStubWiiU();
