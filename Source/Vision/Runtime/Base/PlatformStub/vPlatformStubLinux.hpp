...
/// \file vPlatformStubLinux.hpp


#ifndef VPLATFORMSTUBLINUX_HPP
#define VPLATFORMSTUBLINUX_HPP

// this define should only be set when the WIN32 version
// supports the LINUX (i.e. to save shaders from vForge, ...)
#define WIN32_SUPPORTS_LINUX

#include <Vision/Runtime/Base/PlatformStub/vPlatformStubBase.hpp>

#ifndef _VISION_DOC

class VBASE_IMPEXP_CLASS vPlatformStubLinux : public vPlatformStubBase
{
public:
  vPlatformStubLinux();
  virtual ~vPlatformStubLinux();
