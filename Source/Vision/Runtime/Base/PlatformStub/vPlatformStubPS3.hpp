...
/// \file vPlatformStubPS3.hpp


#ifndef VPLATFORMSTUBPS3_HPP
#define VPLATFORMSTUBPS3_HPP

// this define should only be set when the WIN32 version
// supports the PS3 (i.e. to save shaders from vForge, ...)
#define WIN32_SUPPORTS_PS3

#include <Vision/Runtime/Base/PlatformStub/vPlatformStubBase.hpp>

#ifndef _VISION_DOC

class VBASE_IMPEXP_CLASS vPlatformStubPS3 : public vPlatformStubBase
{
public:
  vPlatformStubPS3();
  virtual ~vPlatformStubPS3();
