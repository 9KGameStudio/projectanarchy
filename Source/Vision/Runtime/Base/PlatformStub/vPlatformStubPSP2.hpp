...
/// \file vPlatformStubPSP2.hpp

#ifndef VPLATFORMSTUBPSP2_HPP
#define VPLATFORMSTUBPSP2_HPP

// this define should only be set when the WIN32 version
// supports the PSP2 (i.e. to save shaders from vForge, ...)
#define WIN32_SUPPORTS_PSP2

#include <Vision/Runtime/Base/PlatformStub/vPlatformStubBase.hpp>

#ifndef _VISION_DOC

class VBASE_IMPEXP_CLASS vPlatformStubPSP2 : public vPlatformStubBase
{
public:
  vPlatformStubPSP2();
  virtual ~vPlatformStubPSP2();
