...
/// \file vPlatformStubDX11.hpp

#ifndef VPLATFORMSTUBDX11_HPP
#define VPLATFORMSTUBDX11_HPP

#include <Vision/Runtime/Base/PlatformStub/vPlatformStubBase.hpp>

#ifndef _VISION_DOC

class VBASE_IMPEXP_CLASS vPlatformStubDX11 : public vPlatformStubBase
{
public:
  vPlatformStubDX11();
  virtual ~vPlatformStubDX11();
