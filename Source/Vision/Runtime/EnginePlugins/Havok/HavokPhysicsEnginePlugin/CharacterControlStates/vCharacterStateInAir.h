...
#ifndef V_CHARACTER_STATE_IN_AIR_H
#define V_CHARACTER_STATE_IN_AIR_H

#include <Physics2012/Utilities/CharacterControl/StateMachine/InAir/hkpCharacterStateInAir.h>

/// \brief
///   This state controls character movement when in the air.
class vCharacterStateInAir : public hkpCharacterStateInAir
{
  public:
...
#endif // V_CHARACTER_STATE_IN_AIR_H
