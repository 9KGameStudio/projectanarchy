...
vCharacterStateInAir::vCharacterStateInAir() : hkpCharacterStateInAir()
{
}

void vCharacterStateInAir::change(hkpCharacterContext& context, const hkpCharacterInput& input, hkpCharacterOutput& output)
{
  ...
  hkpCharacterStateInAir::change(context, input, output);
}
