...
#ifndef V_CHARACTER_STATE_FLYING_H
#define V_CHARACTER_STATE_FLYING_H

#include <Physics2012/Utilities/CharacterControl/StateMachine/Flying/hkpCharacterStateFlying.h>

/// \brief
///   A state to represent flying.
class vCharacterStateFlying : public hkpCharacterStateFlying
{
  public:
...
#endif // V_CHARACTER_STATE_FLYING_H
