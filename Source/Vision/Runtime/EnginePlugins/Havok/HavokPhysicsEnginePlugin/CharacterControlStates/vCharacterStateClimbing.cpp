...
vCharacterStateClimbing::vCharacterStateClimbing() : hkpCharacterStateClimbing()
{
}

void vCharacterStateClimbing::change(hkpCharacterContext& context, const hkpCharacterInput& input, hkpCharacterOutput& output)
{
  ...
  hkpCharacterStateClimbing::change(context, input, output);
}
