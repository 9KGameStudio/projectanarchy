...
#ifndef V_CHARACTER_STATE_ON_GROUND_H
#define V_CHARACTER_STATE_ON_GROUND_H
...
class vCharacterStateOnGround : public hkpCharacterStateOnGround
{
	public:
...
#endif // V_CHARACTER_STATE_ON_GROUND_H
