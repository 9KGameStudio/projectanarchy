...
/// \file vHavokAiElementManager.inl



template<class ELEMTYPE>
vHavokAiElementManager<ELEMTYPE>::vHavokAiElementManager()
{
...
template<class ELEMTYPE>
ELEMTYPE vHavokAiElementManager<ELEMTYPE>::ElementManagerGet(unsigned int index)
{
...
template<class ELEMTYPE>
ELEMTYPE vHavokAiElementManager<ELEMTYPE>::ElementManagerGetAt(unsigned int index)
{
...
template<class ELEMTYPE>
int vHavokAiElementManager<ELEMTYPE>::ElementManagerAdd(ELEMTYPE element)
{
...
template<class ELEMTYPE>
void vHavokAiElementManager<ELEMTYPE>::ElementManagerRemove(unsigned int index)
{
...
template<class ELEMTYPE>
inline void vHavokAiElementManager<ELEMTYPE>::AddToElementManager()       
{
...
template<class ELEMTYPE>
inline void vHavokAiElementManager<ELEMTYPE>::RemoveFromElementManager()  
{
...
template<class ELEMTYPE>
unsigned int vHavokAiElementManager<ELEMTYPE>::ElementManagerGetSize()
{
...
template<class ELEMTYPE>
unsigned int vHavokAiElementManager<ELEMTYPE>::ElementManagerGetUsedCount()
{
...
template<class ELEMTYPE>
unsigned int vHavokAiElementManager<ELEMTYPE>::ElementManagerDeleteAll()
{
...
template<class ELEMTYPE>
unsigned int vHavokAiElementManager<ELEMTYPE>::ElementManagerDeleteAllUnRef(BOOL bResize)
{
...
template<class ELEMTYPE>
ELEMTYPE vHavokAiElementManager<ELEMTYPE>::FindByKey(const char *szObjectKey, DynArray_cl<ELEMTYPE> *storageArray, BOOL bIgnoreCase)
{
...
template<class ELEMTYPE>
ELEMTYPE vHavokAiElementManager<ELEMTYPE>::FindByUniqueID(__int64 iUniqueID)
{
  const unsigned int iCount = elementTable.GetSize();
  for (unsigned int i=0; i<iCount; i++)
  {
...
template<class ELEMTYPE>
void vHavokAiElementManager<ELEMTYPE>::AdjustElementCounter(BOOL bResize)
{
...
template<class ELEMTYPE>
void vHavokAiElementManager<ELEMTYPE>::ElementManagerPopulateFreeElementCache()
{
  ...
  for (unsigned int i=0; i<iCount; i++)
  {
    if (elementTable.GetDataPtr()[i]==NULL)
    {
      ...
      if (g_iNumElementsInCache == V_HAVOKAI_ELEMENT_MANAGER_FREE_INDEX_CACHE_SIZE)
        break;
    }
  }
}
...
template<class ELEMTYPE>
int vHavokAiElementManager<ELEMTYPE>::ElementManagerGetFreePos()
{
  if (g_iCurrentElementCacheIndex==g_iNumElementsInCache)
  {
    ElementManagerPopulateFreeElementCache();
    VASSERT_MSG (g_iResizeGranularity <= V_HAVOKAI_ELEMENT_MANAGER_FREE_INDEX_CACHE_SIZE,
      "g_iResizeGranularity must NEVER be set greater than V_HAVOKAI_ELEMENT_MANAGER_FREE_INDEX_CACHE_SIZE!");
  ...
  VASSERT(g_iCurrentElementCacheIndex < V_HAVOKAI_ELEMENT_MANAGER_FREE_INDEX_CACHE_SIZE);
