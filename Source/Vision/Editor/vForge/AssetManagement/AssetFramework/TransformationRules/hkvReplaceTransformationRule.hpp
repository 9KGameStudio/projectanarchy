...
/// \file hkvReplaceTransformationRule.hpp

#ifndef HKVREPLACETRANSFORMATIONRULE_HPP_INCLUDED
#define HKVREPLACETRANSFORMATIONRULE_HPP_INCLUDED

#include <Vision/Editor/vForge/AssetManagement/AssetFramework/TransformationRules/hkvTransformationRule.hpp>

class hkvReplaceTransformationRule : public hkvTransformationRule
{
public:
...
public:
  ASSETFRAMEWORK_IMPEXP hkvReplaceTransformationRule (hkvTargetPlatform platform);
  ASSETFRAMEWORK_IMPEXP ~hkvReplaceTransformationRule();
...
private:
  static unsigned int s_ruleTypeIndex;
