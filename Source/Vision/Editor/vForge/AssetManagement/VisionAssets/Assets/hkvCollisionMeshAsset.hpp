...
/// \file hkvCollisionMeshAsset.hpp

#ifndef VCOLLISIONMESHTYPE_HPP_INCLUDED
#define VCOLLISIONMESHTYPE_HPP_INCLUDED
...
class hkvCollisionMeshAsset : public hkvAsset
{
public:
