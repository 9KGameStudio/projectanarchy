...
public:
  ...
  hkResult validate(hkArray<hkvAssetLogMessage>& out_messages);
...
private:
  ...
  bool checkFormatCompatibility(hkArray<hkvAssetLogMessage>& out_messages);
  bool determineRestrictions(hkArray<hkvAssetLogMessage>& out_messages);
  bool determineRestrictionsAndroid(hkArray<hkvAssetLogMessage>& out_messages);
  bool determineRestrictionsIos(hkArray<hkvAssetLogMessage>& out_messages);
  bool determineRestrictionsPsVita(hkArray<hkvAssetLogMessage>& out_messages);
  bool ensureDimensionIntegrity(hkArray<hkvAssetLogMessage>& out_messages);
  bool checkDimensions(hkArray<hkvAssetLogMessage>& out_messages);
  bool checkAlpha(hkArray<hkvAssetLogMessage>& out_messages);
