...
{
  /// \brief Managed property class for Fixed constraints.
  /// 
  /// The FixedConstraintState class exposes the properties for fixed
  /// constraints and provides functions for setting/retrieving them on the 
  /// native description.
  [Serializable]
  public ref class FixedConstraintState : public ConstraintStateBase
  {
  public:
  ...
  protected:
    ...
    FixedConstraintState(SerializationInfo ^si, StreamingContext sc);
