...
{
  /// \brief Managed property class for stiff spring constraints.
  /// 
  /// The StiffSpringConstraintState class exposes the properties for stiff spring
  /// constraints and provides functions for setting/retrieving them on the 
  /// native description.
  [Serializable]
  public ref class StiffSpringConstraintState : public ConstraintStateBase
  {
  public:
    /// Constructor. Sets the default values.
    StiffSpringConstraintState();
  ...
  protected:
    ...
    StiffSpringConstraintState(SerializationInfo ^si, StreamingContext sc);
