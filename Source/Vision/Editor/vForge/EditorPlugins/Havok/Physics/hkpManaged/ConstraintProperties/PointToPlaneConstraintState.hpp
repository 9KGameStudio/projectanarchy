...
{
  /// \brief Managed property class for PointToPlane constraints.
  /// 
  /// The PointToPlaneState class exposes the properties for PointToPlane
  /// constraints and provides functions for setting/retrieving them on the 
  /// native description.
  [Serializable]
  public ref class PointToPlaneConstraintState : public ConstraintStateBase
  {
  public:
    /// Constructor. Sets the default values.
    PointToPlaneConstraintState();
  ...
  protected:
    ...
    PointToPlaneConstraintState(SerializationInfo ^si, StreamingContext sc);
