...
namespace VisionEditorPlugin.Shapes
{
	...
	/// </summary>
  [Serializable, ShapeTypeNiceName("Lightgrid Box")]
	public class LightGridBoxShape : Shape3D
	{
    ...
    /// <param name="nodeName"></param>
		public LightGridBoxShape(string nodeName) : base(nodeName)
		{
    ...
    public override void CreateEngineInstance(bool bCreateChildren)
    {
      ...
      this._engineInstance = new EngineInstanceLightGridBoundingBox();
      SetEngineInstanceBaseProperties(); // sets the position etc.
    }

    // accesses the engine instance as an object of type EngineInstanceLightGridBoundingBox
    EngineInstanceLightGridBoundingBox EngineBox {get {return (EngineInstanceLightGridBoundingBox)_engineInstance;}}
    ...
    public override void SetEngineInstanceBaseProperties()
    {
      ...
      {
        EngineBox.SetDisplayGrid(_bPreviewCells);
        EngineBox.SetDisplayIndicators(_bDisplayIndicators);
      }
    }
    ...
    Vector3F _vBoxSize = new Vector3F(4000,4000,1000);
    int _iSubDivX = 32;
    int _iSubDivY = 32;
    int _iSubDivZ = 8;
    bool _bPreviewCells = false;
    bool _bDisplayIndicators = false;
    ...
    PropertyOrder(1),
    Description("Status of displaying the grid cells as lines")]
    public bool PreviewCells
    {
    ...
    [SortedCategory(CAT_GLOBAL, CATORDER_GLOBAL),
    PropertyOrder(1),
    Description("Shows light-grid indicators for all light-grid cells.")]
    public bool ShowIndicators
    {
      get { return _bDisplayIndicators; }
      set
      {
        _bDisplayIndicators = value;
        if (HasEngineInstance())
          EngineBox.SetDisplayIndicators(_bDisplayIndicators);
      }
    }
    ...
    public int SubDivX
    {
      ...
      set 
      {
        ...
        if (_iSubDivX>4096) _iSubDivX = 4096;
        UpdateBox();
      }
    }
    ...
    public int SubDivY
    {
      ...
      set 
      {
        ...
        if (_iSubDivY>4096) _iSubDivY = 4096;
        UpdateBox();
      }
    }
    ...
    public int SubDivZ
    {
      ...
      set 
      {
        ...
        if (_iSubDivZ>4096) _iSubDivZ = 4096;
        UpdateBox();
      }
    }
    ...
    protected LightGridBoxShape(SerializationInfo info, StreamingContext context) : base(info, context)
    {
  ...
  class LightGridBoxCreator : CSharpFramework.IShapeCreatorPlugin
  {
    public LightGridBoxCreator()
    {
    ...
    {
      return "Defines the global bounding box for light grid calculations for this scene.\n"+
        "Positions outside this bounding box will be clamped to the edges when looking up light grid colors.\n"+
        "The shape is only relevant for re-lighting and will thus not be exported. There should only be one instance of this shape in a scene.";
    }
    ...
    {
      return typeof(LightGridBoxShape);
    }
  }
