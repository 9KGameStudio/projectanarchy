...
{
  /// <summary>
  /// Mouse camera context for detail texture painting
  /// </summary>
  public class DetailTextureEditingContext : TerrainEditingBaseContext
  {
    bool _bPaint = false;
    ...
    public override void PreRenderTickFunction(float fTimeDelta)
    {
      ...
      if (_bPaint)
      {
        TerrainEditor.BlitDetailTextureBrush(_bSubtract);
