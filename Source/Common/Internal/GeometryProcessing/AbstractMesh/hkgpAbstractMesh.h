...
#else
	typedef hkGeometryProcessing::LocalArrayAllocator<VERTEX, HKAI_SPU_TRIANGULATOR_MAX_VERTICES>		VertexPoolAllocator;
	typedef hkGeometryProcessing::LocalArrayAllocator<TRIANGLE, HKAI_SPU_TRIANGULATOR_MAX_TRIANGLES>	TrianglePoolAllocator;
#endif
