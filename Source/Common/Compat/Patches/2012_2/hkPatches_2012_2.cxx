...
HK_PATCH_BEGIN(HK_NULL, HK_CLASS_ADDED, "hkQTransformd", 0)
	HK_PATCH_MEMBER_ADDED("rotation", TYPE_VEC_4, HK_NULL, 0)
	HK_PATCH_MEMBER_ADDED("translation", TYPE_VEC_4, HK_NULL, 0)
HK_PATCH_END()

HK_PATCH_BEGIN(HK_NULL, HK_CLASS_ADDED, "hkSweptTransformd", 0)
...
HK_PATCH_BEGIN(HK_NULL, HK_CLASS_ADDED, "hkFourTransposedPointsd", 0)
...
HK_PATCH_BEGIN("hkMotionState", 2, "hkMotionState", 3)
	HK_PATCH_MEMBER_RENAMED("sweptTransform", "sweptTransform_old")
	HK_PATCH_MEMBER_ADDED("sweptTransform", TYPE_TUPLE_VEC_4, HK_NULL, 5)
	HK_PATCH_FUNCTION(hkMotionState_2_to_3)
	HK_PATCH_MEMBER_REMOVED("sweptTransform_old", TYPE_STRUCT, "hkSweptTransformf", 0)
	HK_PATCH_DEPENDS("hkSweptTransformf", 0)
HK_PATCH_END()

HK_PATCH_BEGIN("hkSkinnedRefMeshShape", 0, "hkSkinnedRefMeshShape", 1)
	HK_PATCH_MEMBER_RENAMED("localFromRootTransforms", "localFromRootTransforms_old")
	HK_PATCH_MEMBER_ADDED("localFromRootTransforms", TYPE_ARRAY_VEC_4, HK_NULL, 0)
	HK_PATCH_FUNCTION(hkSkinnedRefMeshShape_0_to_1)
	HK_PATCH_MEMBER_REMOVED("localFromRootTransforms_old", TYPE_ARRAY_STRUCT, "hkQTransformf", 0)
