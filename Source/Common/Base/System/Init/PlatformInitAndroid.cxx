...
#define __STDC_VERSION__ 0 // as we are C++ and string.h will warn etc otherwise
#endif
...
#include <Common/Base/System/Init/PlatformInitAndroid.h>
...
extern "C" { // Important to expose as C not C++ so that names are not mangled in our .so

#ifndef HK_ANDROID_PLATFORM_8

struct android_app* g_currentApp = HK_NULL;

void android_main(struct android_app* state) 
{
	// so we can find packed assets:
	hkAndroidAssetManagerFileSystem::s_manager = state->activity->assetManager;
	g_currentApp = state;
