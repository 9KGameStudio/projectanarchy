 ...
 *
 */
#ifndef HK_hkAndroidAssetManagerFileSystem_H
#define HK_hkAndroidAssetManagerFileSystem_H

#include <Common/Base/System/Io/FileSystem/hkFileSystem.h>

struct AAssetManager;

class hkAndroidAssetManagerFileSystem : public hkFileSystem
{
	public:
...
#endif //HK_hkAndroidAssetManagerFileSystem_H
