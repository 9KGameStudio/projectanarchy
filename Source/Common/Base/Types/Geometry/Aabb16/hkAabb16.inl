...
HK_FORCE_INLINE bool hkAabb16::isEndMarker() const
{
...
{
	// Avoid floating point copies on WiiU, since any denormals in the paired single floats would be set to zero. (COM-2545)
#if (HK_CONFIG_SIMD == HK_CONFIG_SIMD_ENABLED) && !defined(HK_REAL_IS_DOUBLE) && !defined(HK_PLATFORM_WIIU)
...
HK_FORCE_INLINE hkUint32 hkAabb16::getMinXSortKey() const
{
	return m_min[0];
}

HK_FORCE_INLINE hkUint32 hkAabb16::getMaxXSortKey() const
{
	return m_max[0];
}
...
void hkAabb16::getCenter(hkUint32 c[3]) const
{
