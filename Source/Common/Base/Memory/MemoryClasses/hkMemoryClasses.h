...
HK_MEMORY_CLASS_DEFINITION_START
	...
	HK_MEMORY_CLASS(MILSIM_CIGI,		HK_MEMORY_CLASS_MILSIM)
	HK_MEMORY_CLASS(MILSIM_CHARACTER,	HK_MEMORY_CLASS_MILSIM)
	HK_MEMORY_CLASS(MILSIM_VEHICLE,		HK_MEMORY_CLASS_MILSIM)
