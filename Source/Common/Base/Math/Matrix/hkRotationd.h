...
class HK_FORCE_ALIGN_ROTATION HK_EXPORT_COMMON hkRotationd : public hkMatrix3d
{
	public:
		...
		bool isOrthonormal( hkDouble64 epsilon = hkDouble64(1e-5) ) const;

			/// Returns a global identity matrix3.
		HK_FORCE_INLINE static const hkRotationd& HK_CALL getIdentity();
