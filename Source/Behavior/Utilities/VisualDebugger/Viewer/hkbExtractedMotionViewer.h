...
#ifndef HKB_EXTRACTED_MOTION_VIEWER_H
#define HKB_EXTRACTED_MOTION_VIEWER_H
...
class hkbExtractedMotionViewer: public hkbWorldViewerBase						   
{
	public:
		...
		hkbExtractedMotionViewer(const hkArray<hkProcessContext*>& contexts);
			/// Destructs the viewer
		~hkbExtractedMotionViewer();
		...
		static inline const char* HK_CALL getName() { return "Behavior Extracted Motion"; }
